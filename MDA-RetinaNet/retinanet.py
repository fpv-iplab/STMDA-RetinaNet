...
class RetinaNet(nn.Module):
    ...
    def forward(self, batched_inputs, domain = "source", alpha3 = 1):
        """
        Args:
        ...
        if self.training:
            ...
            losses = self.losses(anchors, pred_logits, gt_labels, pred_anchor_deltas, gt_boxes, res["res3"], domain, alpha3)
    ...
    def losses(self, anchors, pred_logits, gt_labels, pred_anchor_deltas, gt_boxes, res3, domain, alpha3):
        """
        Args:
